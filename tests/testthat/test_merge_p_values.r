...
test_that("Merged p-values are correct", {
      ...
      test_direction_vector <- c(1,-1)
      expected_direction1 <- c(-1,1)
      expected_direction2 <- c(1,-1)
      
      expect_equal(merge_p_values(test_pval_vector,"Fisher",test_direction_vector,expected_direction1),
                   merge_p_values(test_pval_vector,"Fisher",test_direction_vector,expected_direction2))
