...
1. `Aggregated_merged_pathways.txt` - Combined significant pathways with p-values
2. `Aggregated_merged_subgroups.txt` - Information about which datasets support each pathway and directional impact
3. `Aggregated_merged_pathways.gmt` - A filtered GMT file containing only the significant pathways
