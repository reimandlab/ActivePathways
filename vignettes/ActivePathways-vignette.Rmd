...
The `overlap` column provides the set of genes of the input ranked gene list that were found in the given gene set (i.e., molecular pathway or biological process). Note that the genes with the strongest scores across the multiple datasets are listed first. 
...
```{r}
result.file <- paste('ActivePathways_results.txt', sep = '/')
export_as_CSV (res, result.file)
