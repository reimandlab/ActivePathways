...
```{r}
files <- paste(system.file('extdata', package='activePathways'), c('cytoscape_terms.txt', 'cytoscape_groups.txt', 'cytoscape_abridged.txt', 'legend.pdf'), sep='/')
res <- activePathways(scores, gmt.file, cytoscape.filenames=files)
```
...
* `cytoscape.filenames[4]` a pdf file of a legend which can be used as reference to the generated cytoscape plot.
